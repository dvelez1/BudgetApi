...
{
    public partial class home_budgetContext : DbContext
    {
        public home_budgetContext()
        {
        }

        public home_budgetContext(DbContextOptions<home_budgetContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MasMonthlyExpense>(entity =>
            {
                ...
                entity.Property(e => e.MasMonthlyExpensesId)
                    .ValueGeneratedNever()
                    .HasColumnName("mas_monthly_expenses_id");
